...
.btn:hover {background: #6acad9;}\
</style></head>\
<body>\
<button class=\"btn\" onclick=\"getName();getSpecies()\">Get name and species</button>\
...
void getName()
{
  String name = "name"; //this will be replaced in the final code
  server.send(200, F("text/plain"), name);
}

void getSpecies()
{
  String species = "duck"; //this will be replaced in the final code
